    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
            ...
            try:
                ...
                await bot.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton(" 𝙹𝚘𝚒𝚗 𝙼𝚊𝚒𝚗 𝙲𝚑𝚊𝚗𝚗𝚎𝚕 📢", url=invite_link.invite_link)
                            ],
                            [
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('𝙎𝙚𝙖𝙧𝙘𝙝 𝙈𝙤𝙧𝙚🔎', url=f'http://t.me/MC_Group1')
                    ]
                    ]
        ...
        await bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("𝐽𝑜𝑖𝑛 𝑀𝑎𝑖𝑛 𝐶ℎ𝑎𝑛𝑛𝑒𝑙 📢", url=invite_link.invite_link)
                    ]
                ]
            )
        )
        ...
        await message.reply_photo(
            photo="https://telegra.ph/file/8d77c0a94306c47dc217c.jpg",
            caption=START_MSG,
            reply_markup=InlineKeyboardMarkup(
                [[
                InlineKeyboardButton("♂️𝗦𝗲𝗮𝗿𝗰𝗵 𝗛𝗲𝗿𝗲♂️", switch_inline_query_current_chat=''),
                InlineKeyboardButton("♈𝗖𝗵𝗮𝗻𝗻𝗲𝗹♈", url="https://t.me/MalluCinemas_Official")
                ],[
...
async def bot_info(bot, message):
    buttons = [
        [
            InlineKeyboardButton('🌟𝗚𝗿𝗼𝘂𝗽🌟', url=f'http://t.me/MC_Group1')
        ]
        ]
